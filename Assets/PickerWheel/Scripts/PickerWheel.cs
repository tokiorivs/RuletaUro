...
namespace EasyUI.PickerWheelUI {
   ...
   public class PickerWheel : MonoBehaviour {
      ...
      [Range (1, 40)] public float spinDuration = 0.5f ;
      ...
      public void Spin () {
         if (!_isSpinning) {
            ...
            Debug.Log("le random anglulo es " + randomAngle);
            Debug.Log("el leftoffset es :" + leftOffset);
            Debug.Log("el offset right " + rightOffset);

            Vector3 targetRotation = Vector3.back * (randomAngle + 2 * 360 * spinDuration) ;
            Debug.Log("el target rotation es:" + targetRotation);
